...
### Evaluation Plots
Below is the evaluation overview including ROC Curve, Precision-Recall Curve, and Confusion Matrix:

![Model Performance](model_performance.jpg)

### Feature Importance (Interpretation)
To understand the biological drivers of the prediction, we analyzed feature importance using SHAP values. The top predictors include **hypertension**, **pulse pressure**, and **age**, which aligns with established medical knowledge.

![SHAP Summary](shap_summary.jpg)
